...
\newcommand{\titulo}{Programación básica y Programación de algoritmos paralelos con OpenMP} % Título completo
\newcommand{\titred}{Porgramación con OpenMP} % Título corto
...
\begin{document}
    ...
    % INTRODUCCION
    \input{1_estructura/1_introduccion.tex}
    \input{1_estructura/2_entorno.tex}
    \input{1_estructura/3_ej1.tex}
    % CONCLUSIONE
